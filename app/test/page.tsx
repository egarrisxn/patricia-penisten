...
import HeroTwo from "@/components/landing/hero-two";
import HeroThree from "@/components/landing/hero-three";
  ...
  return (
    <div className='mx-auto grid w-full overflow-x-hidden'>
      ...
      <main className='to-background bg-radial from-blue-100 from-40% dark:from-slate-800'>
        <section id='herotwo' className='rounded-b-lg'>
        ...
        <section id='herothree' className='rounded-b-lg'>
          <div className='relative min-h-screen w-full overflow-hidden'>
            <HeroThree />
          </div>
        </section>
