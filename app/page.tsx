  ...
  return (
    <div className='grid min-h-dvh w-full grid-rows-[auto_1fr_auto]'>
      ...
      <main>
        ...
        <div className='to-background bg-radial from-blue-100 from-25% dark:from-slate-800'>
          <section
            id='herstory'
            className='4xl:pb-32 4xl:pt-34 py-24 sm:py-22 lg:py-24 xl:pt-26 2xl:pt-30'
          >
          ...
          <section
            id='photogallery'
            className='4xl:pb-32 4xl:pt-34 py-24 sm:py-22 lg:py-24 xl:pt-28 2xl:pt-30'
          >
            <div className='mx-auto max-w-7xl px-4 sm:px-6 md:px-8 2xl:max-w-[84rem]'>
              <LandingHeader
