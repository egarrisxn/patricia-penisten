...
export function ScrollDownFarewell() {
  ...
  return (
    <button
      className='dark:bg-input/30 animate-slow-bounce dark:hover:bg-input/50 text-accent-foreground/90 hover:text-accent-foreground xs:size-10 z-50 mx-auto flex size-9 cursor-pointer flex-col items-center justify-center rounded-full border-0 bg-white/95 shadow-lg transition-all hover:bg-white hover:shadow-xl hover:backdrop-blur-sm'
