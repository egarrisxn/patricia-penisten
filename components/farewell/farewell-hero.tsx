    ...
    >
      <div className='mx-auto flex w-fit px-4'>
        ...
        >
          ...
          <h1 className='text-foreground/90 xs:text-[3.65rem] font-serif text-[2.9rem] leading-none font-extrabold text-shadow-lg/20 sm:text-[4.2rem] md:text-[4.5rem] lg:text-[4.75rem] xl:text-[5.2rem] 2xl:text-[6rem]'>
          ...
          <h2 className='mt-2 mb-8 flex items-center gap-2 xl:mb-10 2xl:mb-12'>
            ...
            <span className='xs:text-[1.2rem] text-[1.1rem] leading-none font-medium sm:text-[1.35rem] md:text-[1.45rem] lg:text-[1.5rem] 2xl:text-[1.75rem]'>
