    ...
    <div className='relative min-h-screen w-full'>
      <div className='relative grid min-h-screen w-full grid-rows-[1fr_30%] md:grid-rows-[1fr_15%] lg:grid-rows-[1fr_10%]'>
        ...
        >
          <motion.article
            variants={ITEM_FADE}
            className='mx-auto flex w-full flex-col items-center justify-center px-4 pt-12 text-center md:pt-0'
          >
            ...
            <div className='xs:mb-10 mb-8 flex items-center gap-2 md:mb-6 lg:mb-10'>
              ...
              <h2 className='xs:text-xl ms:leading-none text-lg font-medium sm:text-[1.35rem] md:text-xl lg:text-3xl xl:text-[1.88rem] 2xl:text-[1.7rem] 2xl:leading-[1.05]'>
