  ...
  return (
    <div className="mx-auto pb-4 pl-2 xs:px-4 xl:px-12 xl:pb-12">
      <div className="relative">
        {/* Timeline line */}
        <div className="absolute left-0 h-full w-0.5 bg-linear-to-b from-rose-200 via-blue-200 to-rose-200 md:left-1/2 md:-translate-x-1/2" />
                  ...
                  >
                    <div className="rounded-b-lg bg-card p-6 shadow-lg transition-shadow duration-300 group-hover:shadow-lg md:rounded-lg md:hover:shadow-lg lg:dark:border">
                      <div className="mb-6 flex items-center">
                        <div className="rounded-md bg-linear-to-br from-blue-500/80 to-purple-700/80 px-2.5 py-1 text-xs font-medium text-white shadow-lg">
                          {item.time}
                        </div>
                      </div>
        ...
        {/* Final dot */}
        <div className="absolute left-px -translate-x-1/2 -translate-y-2 transform md:left-1/2">
          <div className="size-3.5 rounded-full border-2 border-white bg-indigo-400 shadow-lg md:size-4 md:border-3"></div>
        </div>
      </div>
            ...
            <>
              ...
              <div className="px-4 pt-1 pb-4">
                <DialogHeader className="mb-3">
                  ...
                  <DialogDescription className="ml-px text-start text-xs leading-tight text-accent-foreground md:text-sm">
                    {selectedItem.time}
                  </DialogDescription>
                </DialogHeader>
                <div className="mt-4 ml-px line-clamp-3 pr-4 pb-0.5 text-start text-sm leading-[1.4] font-medium text-wrap text-foreground md:text-base">
