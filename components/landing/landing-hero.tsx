  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className='5xl:text-[4.8rem] 4xl:text-[4.6rem] xs:text-[2.4rem] mb-2.5 font-serif text-[2.3rem] leading-none font-bold tracking-tight text-blue-300/90 text-shadow-lg/20 sm:text-[2.65rem] md:mb-1.5 md:text-[2.55rem] lg:text-[3.4rem] xl:text-[3.9rem] xl:tracking-normal 2xl:text-[4.45rem]'>
            Patricia G. Penisten
          </h1>
          <h2 className='5xl:text-[1.85rem] 4xl:text-[1.65rem] xs:text-[0.95rem] mb-10 text-[0.9rem] leading-none tracking-tight text-white/95 sm:text-[1.1rem] md:mb-6 md:ml-0.5 md:text-[1.15rem] lg:mb-9 lg:text-[1.4rem] lg:leading-snug xl:text-[1.6rem] xl:leading-tight xl:tracking-normal 2xl:mb-8.5 2xl:text-[1.8rem]'>
            December 22nd, 1935 - June 5th, 2025
          </h2>
          <h3 className='5xl:text-[3rem] 4xl:text-[2.65rem] max-w-sm text-2xl leading-snug tracking-tight text-white sm:text-[1.7rem] md:ml-0.5 md:text-[1.75rem] lg:text-[2rem] lg:leading-[1.425] lg:tracking-normal xl:max-w-xl xl:text-[2.5rem] xl:leading-snug 2xl:text-[2.95rem] 2xl:leading-tight'>
            Beloved{" "}
            <span className='font-semibold text-orange-400/90 text-shadow-lg/20'>
              Teacher
            </span>
            ,{" "}
            <span className='font-semibold text-orange-400/90 text-shadow-lg/20'>
