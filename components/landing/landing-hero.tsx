...
export default function LandingHero() {
  return (
    <section id='home' className='relative h-screen w-full overflow-hidden'>
      ...
      {/* Middle section with staggered animation */}
      <div className='absolute inset-0 z-30 flex size-full pb-42 sm:pb-24 lg:pb-28'>
        <motion.div
          className='5xl:max-w-7xl mx-auto flex w-full max-w-6xl flex-col items-center justify-center gap-6 px-4 lg:flex-row lg:gap-4'
        ...
        >
          ...
          <motion.header
            variants={itemVariants}
            className='flex flex-col items-center justify-center rounded-lg text-center lg:items-start lg:justify-start lg:text-start'
          >
