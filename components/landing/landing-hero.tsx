...
export default function LandingHero() {
  return (
    <>
      <motion.div
        className='bg-background absolute inset-0 z-10 min-h-screen w-full'
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <Image
          ...
          fill
          priority
          className='bg-background object-cover blur-sm brightness-[.4]'
        />
      </motion.div>
      ...
      <motion.div
        ...
        initial='hidden'
        animate='visible'
        className='5xl:max-w-7xl xs:px-4 xs:pt-8 xs:pb-48 absolute inset-0 z-30 mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center gap-4 px-2 pb-56 md:flex-row md:pb-24 lg:pb-16'
      >
        <motion.aside
          variants={ITEM_FADE}
