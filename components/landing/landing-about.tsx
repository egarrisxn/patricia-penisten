...
export default function LandingAboutCard() {
  return (
    <div className="mx-auto flex w-fit flex-col gap-y-8 px-2 py-8 xs:w-md xs:px-4 sm:w-full lg:grid lg:grid-cols-[1fr_auto] lg:items-start lg:gap-x-8 lg:gap-y-0 lg:rounded-lg lg:bg-card lg:px-2 lg:shadow-lg xl:px-12 xl:py-16 lg:dark:border">
      {/* Title */}
      <div className="w-full max-w-lg px-2 sm:mx-auto lg:max-w-none lg:space-y-4 lg:pt-2 lg:pl-4 xl:pr-4">
      ...
      >
        <Image
          ...
          height={500}
          width={500}
          className="aspect-square rounded-lg border-2 border-accent-foreground bg-foreground object-cover shadow-lg lg:max-w-md xl:max-w-full"
        />
      </motion.aside>
      ...
      <motion.article
        ...
        className="w-full max-w-lg px-2 sm:mx-auto lg:hidden"
      >
