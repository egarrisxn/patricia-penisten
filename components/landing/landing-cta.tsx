  ...
  return (
    <div className="mx-auto grid min-h-screen w-full place-items-center pt-6 pb-12 xl:pt-16 xl:pb-24">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-8 xl:px-12">
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center justify-center gap-10 px-2 text-center xs:gap-8 xs:px-4 lg:flex-row lg:gap-4 2xl:max-w-none">
          <motion.aside
          ...
          <motion.article
            ...
            className="flex w-full flex-1 flex-col gap-5 px-2 xs:max-w-100 xs:gap-4 xs:px-4 md:max-w-md md:px-4 md:pb-8 lg:max-w-none lg:text-start 2xl:gap-5"
          >
            <h6 className="font-serif text-[1.85rem] leading-[1.2] font-black text-shadow-lg/10 xs:text-[1.95rem] sm:text-[2.5rem] md:text-[2.35rem] md:leading-[1.15] lg:text-[3.75rem] lg:leading-[1.05] xl:text-[4rem] 2xl:text-[4.55rem]">
