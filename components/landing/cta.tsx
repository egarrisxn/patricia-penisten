...
export default function CTA() {
  return (
    <section
      id='cta'
      className='5xl:pt-40 5xl:pb-72 bg-gradient-to-t from-slate-200 via-slate-100 to-slate-50 pt-24 pb-40 md:pt-24 md:pb-64 xl:pt-36 xl:pb-68 dark:from-slate-900/80 dark:via-slate-950/80 dark:to-slate-950'
    >
